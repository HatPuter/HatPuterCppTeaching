/****************************************************************************
** Meta object code from reading C++ file 'GameMain.h'
**
...
#error "The header file 'GameMain.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GameMain_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GameMain_t qt_meta_stringdata_GameMain = {
    {
QT_MOC_LITERAL(0, 0, 8) // "GameMain"
...
QT_INIT_METAOBJECT const QMetaObject GameMain::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_GameMain.data,
    qt_meta_data_GameMain,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GameMain::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GameMain.stringdata0))
